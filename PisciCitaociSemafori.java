 ...
 */
public class PisciCitaociSemafori extends Application {

	private class Pristup {
		
		private Semaphore baza = new Semaphore(1);
	...
	protected final Operation pisanje = duration("7±2").text("Пише").container(resurs).textAfter("Завршио")
			.update(this::azuriraj);;
	protected final Operation citanje = duration("5±2").text("Чита").container(resurs).textAfter("Завршио")
			.update(this::azuriraj);;
